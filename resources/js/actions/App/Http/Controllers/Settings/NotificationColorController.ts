...
export const update = (
    args:
        | { notification_color: string | number | { id: string | number } }
        | [notification_color: string | number | { id: string | number }]
        | string
        | number
        | { id: string | number },
...
update.url = (
    ...
    const parsedArgs = {
        notification_color:
            typeof args.notification_color === 'object'
    ...
    return (
        update.definition.url
            .replace(
                '{notification_color}',
                parsedArgs.notification_color.toString(),
            )
...
const NotificationColorController = { index, store, update, destroy };

export default NotificationColorController;
